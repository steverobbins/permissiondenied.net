...
<script type="text/javascript" src="<?=version("js/highlight.min.js", true)?>"></script>
<script type="text/javascript" src="<?=version("js/jquery.js", true)?>"></script>
<?php /*<script type="text/javascript" src="<?=version("js/global.js")?>"></script>*/ ?>
<script type="text/javascript">

    <?=file_get_contents(SERVER_BASE . "cdn/js/global.js")?>

</script>
<!-- AddThis Welcome BEGIN -->
<script type="text/javascript" src="//s7.addthis.com/js/250/addthis_widget.js#pubid=ra-507625574f1c0cf9"></script>
<script type='text/javascript'>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-16126282-16']);
