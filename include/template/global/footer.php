<div id="footer">
    ...
    <p><a href="<?=ROOT?>contact">Contact</a> | <a href="<?=ROOT?>resume">Resume</a> | <a href="https://github.com/stevether/permissiondenied.net" target="_blank">Fork Me</a> | <a href="<?=ROOT?>privacy-policy.php">Privacy Policy</a> | <a href="<?=ROOT?>terms-of-use.php">Terms of Use</a><br /><a href="http://stackoverflow.com/q/12850886/763468" title="How I Did It" target="_blank"><?=$db->queryCount()?> MySQL Quer<?=$db->queryCount() == 1 ? 'y' : 'ies' ?></a> | Page rendered in <?=microtime() - RENDER_TIME_START?> seconds</p>
